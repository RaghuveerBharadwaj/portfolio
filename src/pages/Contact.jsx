...
export const Contact = () => {
  ...
  return (
    <div className="contact">
      ...
      <img width={0} height={0} src={`assets/images/contact/contact.png`} alt="Raghuveer Portfolio Contact" />
      <img width={0} height={0} src={`assets/images/contact/contact-yes.png`} alt="Raghuveer Portfolio Success" />
      <img width={0} height={0} src={`assets/images/contact/contact-no.png`} alt="Raghuveer Portfolio Don't Close" />
      <img width={0} height={0} src={`assets/images/contact/contact-err.png`} alt="Raghuveer Portfolio Error" />
      <img width={0} height={0} src={`assets/images/contact/contact-typing.png`} alt="Raghuveer Portfolio Error" />
      <h1>
        Thanks for taking the time to reach out.
        How can I help you today?
      </h1>
      <div className="frame">
        <img src={`assets/images/contact/contact${pic}.png`} alt="Raghuveer Portfolio Contact" />
      </div>
